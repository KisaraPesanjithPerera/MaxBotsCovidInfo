...
def staat(qq):
  ...
  data = {
    ...
    "caption": "**Get instant access to Corona in Sri Lanka 📊 . I'm automatically retrieve the latest corona informations 🦠 . Use /help for more information. @SweetAngelUpdates**",
    "parse_mode": "HTML",
    "reply_markup": {
        "inline_keyboard": [
            [
